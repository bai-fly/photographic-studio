<template>
	<div class="app-container">
		...
		<!-- 编辑 -->
		<el-dialog title="新增/修改会员" :visible.sync="showEdit" width="550px">
	...
	methods: {
		showEditModal(model) {
			if (model) {
				...
				this.edit.id = null;
				this.edit.name = '';
				(this.edit.account = ''), (this.edit.password = ''), (this.edit.avatar = ''), (this.edit.sex = 1), (this.edit.role = 2), (this.edit.desc = '');
			}
			this.showEdit = true;
		},
